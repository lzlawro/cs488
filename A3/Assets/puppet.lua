-- Create the top level rootNode node named 'rootNode'.
rootNode = gr.node('rootNode')

rootNode:translate(0.0, 0.25, -2.5)
...
-- ----------------------------------------------------------------------------------------
-- Right upper Leg
rightUpperLegJoint = gr.joint('rightUpperLegJoint', {-70, 0, 70}, {0, 0, 0})
...
-- Right Lower Leg
rightLowerLegJoint = gr.joint('rightLowerLegJoint', {0, 0, 100}, {0, 0, 0})

rightLowerLegJoint:translate(0.0, -0.9, 0.0)
...
rightLowerLeg:translate(0.0, 0.3, 0.0)
...
rightFoot:translate(0, 0.3, 0.05)
...
-- ------------------------------------------------------------------------------------
-- Right lower arm
rightLowerArmJoint = gr.joint('rightLowerArmJoint', {-60, 0, 0}, {0, 0, 0})
...
-- ----------------------------------------------------------------------------------------
-- left upper arm
leftUpperArmJoint = gr.joint('leftUpperArmJoint', {-60, 0, 60}, {0, 0, 0})
...
-- ------------------------------------------------------------------------------------
-- left lower arm
leftLowerArmJoint = gr.joint('leftLowerArmJoint', {-60, 0, 0}, {0, 0, 0})
...
-- ----------------------------------------------------------------------------------------
-- left hand
leftHandJoint = gr.joint('leftHandJoint', {0, 0, 0}, {0, 0, 0})
...
-- ----------------------------------------------------------------------------------------
-- left upper Leg
leftUpperLegJoint = gr.joint('leftUpperLegJoint', {-70, 0, 70}, {0, 0, 0})
...
-- left Lower Leg
leftLowerLegJoint = gr.joint('leftLowerLegJoint', {0, 0, 100}, {0, 0, 0})

leftLowerLegJoint:translate(0.0, -0.9, 0.0)
leftUpperLegJoint:add_child(leftLowerLegJoint)

leftLowerLeg = gr.mesh('sphere', 'leftLowerLeg')
leftLowerLeg:scale(0.05, 0.3, 0.05)
leftLowerLeg:translate(0.0, 0.3, 0.0)
...
leftFoot:translate(0, 0.3, 0.05)
leftFoot:set_material(black)
leftFootJoint:add_child(leftFoot)

-- -- ----------------------------------------------------------------------------------------
neckJoint = gr.joint('neckJoint', {0, 0, 0}, {0, 0, 0})
...
-- ------------------------------------------------------------------------------------
-- head
headJoint = gr.joint('headJoint', {0, 0, 0}, {-80, 0, 80})
...
-- Return the rootNode with all of it's childern.  The SceneNode A3::m_rootNode will be set
